...
String filename;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            p = runtime.exec("C:/xampp/mysql/bin/mysqldump.exe -uroot -p1234567 --add-drop-database -B library -r"+path);
            
            int processComplete = p.waitFor();
            if(processComplete==0){
                jLabel1.setText("Back up created succesfully..");
            }
            
            else{
                jLabel4.setText("Failed to create backup.. please try again!");
            }
